...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="active"><a href="listarAcao.php"><svg class="glyph stroked video"><use xlink:href="#stroked-video"></use></svg>Ação</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Listar Ações <a href="cadastrarAcao.php" style="float:right">Cadastrar Ação</a></div>
					<div class="panel-body">

						<?php
						$con = mysqli_connect("mysql.hostinger.com.br","u766907098_root","123456","u766907098_rspro");
						$result = mysqli_query($con,'SELECT id_acao,nome,tipo,dt_inicio,descricao,id_contrato FROM acao');
						...
						echo "<td> <a href='editarAcao.php?id={$row['id_acao']}' > Editar </a></td>";
						echo "<td> <a href='conexaoExcluirAcao.php?id={$row['id_acao']}' > Excluir </a></td>";
						echo "</tr>";
						}
						echo "</table>";
